...
public class LevelMapController : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    /// </summary>
    private List<LevelMapData> _data;
    /// <summary>
    ...
    bool isRevesed = true;
    int count = 0;
    private List<LevelMapData> list1 = new List<LevelMapData>();
    /// <summary>
    ...
    private void LoadData()
    {
        ...
        for (int i = 1; i <= totalLevel; i++)
        {
            ...
            if (isRevesed == true)
            {
                list1.Add(new LevelMapData() { levelTxt = i.ToString(), isUnLock = false, isPass = false });
                count++;
            ...
            {
                _data.Add(new LevelMapData() { levelTxt = i.ToString(), isUnLock = false, isPass = false });
